...
{				/* 17-word finite-state machine  */
	...
	DWORD regs(0), regs(1), regs(2), regs(3), regs(4);
	DWORD regs(5), regs(6), regs(7), regs(8), regs(9);
	DWORD regs(10), regs(11), regs(12), regs(13), regs(14);
	DWORD regs(15), regs(16);
	...
	static DWORD null_in[PAN_STAGE_SIZE] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	DWORD dummy_out[PAN_STAGE_SIZE];
	DWORD in_step, out_step;
...
DWORD _mcrypt_algorithm_version(void)
{
	return 20010801;
}
